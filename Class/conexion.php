...
class Conexion{
    ...
    private function servidor($nameServer) {
        ...
        }elseif($nameServer == 'localhost'){
            return array($this->host_local, $this->database_local);
